...
Class Action {
	...
	function delete_student_grade(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM grade where id = ".$id);
		if($delete){
			return 1;
		}
	}
	...
	function save_grade(){
		...
		$sql = "UPDATE grade SET it1='$it1', it2='$it2', it3='$it3', it4='$it4', it5='$it5', thps='$thps', trs='$trs' WHERE id='$id'";
