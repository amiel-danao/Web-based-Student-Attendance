...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=grade_list" class="nav-item nav-grade_list"><span class='icon-field'><i class="fa fa-tasks "></i></span> Enter Grade</a>
				<a href="index.php?page=grade_record" class="nav-item nav-grade_record"><span class='icon-field'><i class="fa fa-tasks "></i></span> Grade Record</a>
